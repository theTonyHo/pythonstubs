...
class FormattedText(Widget):
    ...
    @property
    def MaximumHeight(self) -> Single: ...
    @property
    def MaximumSize(self) -> SizeF: ...
    @property
    def MaximumWidth(self) -> Single: ...
    @property
    def Text(self) -> str: ...
    @property
    ...
    def MaximumHeight(self, value: Single) -> None: ...
    @MaximumSize.setter
    def MaximumSize(self, value: SizeF) -> None: ...
    @MaximumWidth.setter
    def MaximumWidth(self, value: Single) -> None: ...
    @Text.setter
...
class Graphics(Widget):
    ...
    @overload
    def DrawText(self, font: Font, brush: Brush, x: Single, y: Single, text: str) -> None: ...
    @overload
